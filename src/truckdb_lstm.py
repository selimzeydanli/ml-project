...
from src.utils import get_truck_dbs_lstm_dir, empty_folder

empty_folder(get_truck_dbs_lstm_dir())
...
def run():
    ...
    for day in pd.date_range(start_date, end_date):
        ...
        truck_df.to_json(os.path.join(get_truck_dbs_lstm_dir(), f'TruckDatabase_lstm-{day}.json'), orient='records')
