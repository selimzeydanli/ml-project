...
order_dbs_dir = os.path.join(get_data_dir(), 'OrderDatabases_lstm')
...
def run():
    ...
    for day in pd.date_range(start_date, end_date):
        ...
        order_df.to_json(os.path.join(order_dbs_dir, f'OrderDatabase_lstm-{ready_day}.json'), orient='records')
